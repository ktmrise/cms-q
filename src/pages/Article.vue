  ...
  <div class="article">
    ...
    <div class="article_tbl" v-loading='loading'>
      <el-table :border='true' size='small' :data="articles" style="width: 100%"
        ...
        <el-table-column prop="cateGoryName" label="所属栏目" align="center" width="100"></el-table-column>
        ...
        <el-table-column prop="viewCount" label="阅读次数" width="90" align='center'></el-table-column>
    ...
    <!-- 分页结束 -->
    <!-- 模态框区 -->
    <el-dialog :before-close='handleBeforeClose' :close-on-press-escape='false' @close='handleCloseDialog' fullscreen
               :title="articleDialog.title" :visible.sync="articleDialog.visible">
  ...
  export default {
    ...
    methods: {
      ...
      batchDeleteArticles() {
        ...
        // })
        // // alert(ids);
        // axios.post('/manager/article/batchDeleteArticles', {ids: ids}).then(function (response) {
        ...
        this.$confirm('此操作将永久删除该文章，以及该文章还有及其所有评论, 是否继续?', '提示', {
          ...
          .then(()=>{
            let url = '/manager/article/batchDeleteArticles';
